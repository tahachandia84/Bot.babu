  ...
  run: async function({ api, message, args }) {
    ...
    if (!args.length) {
      try {
        ...
        if (senderID === "100085636015827") replyCategory = "100085636015827";
